            ...
            <div className='flex justify-between items-center'>
                ...
                <div className='hidden md:flex'>
                    <ul className='flex flex-row'>
                        <a href="#home"><li className='mr-4 transition-all ease-in-out hover:scale-110 cursor-pointer hover:text-purple-600'>Home</li></a>
                        <a href="#about-me"><li className='mr-4 transition-all ease-in-out hover:scale-110 cursor-pointer hover:text-purple-600'>ABout Me</li></a>
                        <a href="#skills"><li className='mr-4 transition-all ease-in-out hover:scale-110 cursor-pointer hover:text-purple-600'>Skills</li></a>
                        <a href="#portfolio"><li className='mr-4 transition-all ease-in-out hover:scale-110 cursor-pointer hover:text-purple-600'>Portfolio</li></a>
                        <a href="#companies"><li className='mr-4 transition-all ease-in-out hover:scale-110 cursor-pointer hover:text-purple-600'>Companies</li></a>
                        <a href="#contact-me"><li className='mr-4 transition-all ease-in-out hover:scale-110 cursor-pointer hover:text-purple-600'>Contact Me</li></a>
                    </ul>
                </div>
                <div className='md:hidden lg:hidden'>
                    ...
                    {toggle ?
                        <ul className={`md:flex flex-col mt-12 md:items-center pb-12 left-0 md:z-auto z-50 w-full bg-gray-300 p-2 absolute md:static md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in-out `}>
                            <a href="#home"><li className='p-3 transition-all ease-in-out hover:scale-110 cursor-pointer hover:text-purple-600'>Home</li></a>
                            <a href="#about-me"><li className='p-3 transition-all ease-in-out hover:scale-110 cursor-pointer hover:text-purple-600'>ABout Me</li></a>
                            <a href="#skills"><li className='p-3 transition-all ease-in-out hover:scale-110 cursor-pointer hover:text-purple-600'>Skills</li></a>
                            <a href="#portfolio"><li className='p-3 transition-all ease-in-out hover:scale-110 cursor-pointer hover:text-purple-600'>Portfolio</li></a>
                            <a href="#companies"><li className='p-3 transition-all ease-in-out hover:scale-110 cursor-pointer hover:text-purple-600'>Companies</li></a>
                            <a href="#contact-me"><li className='p-3 transition-all ease-in-out hover:scale-110 cursor-pointer hover:text-purple-600'>Contact Me</li></a>
                        </ul>
                        :
                        null
                    }
